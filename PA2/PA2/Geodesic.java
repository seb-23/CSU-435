...
public class Geodesic {
	...
	public static class PreviousMapper extends Mapper<Object, Text, Text, Text> {
		...
		protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			context.write(new Text(s[0]), new Text("P" + reverse ));  // <7, 1~7>
			context.write(new Text(s[s.length-1]), new Text("P" + value.toString())); // <9, 7~1>
		}
	}
	...
	public static class PlusOneReducer extends Reducer<Text, Text, Text, NullWritable> {
		...
		protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			...
			ArrayList<String> P = new ArrayList<String>(); // <7, 1~7>
			ArrayList<String> L = new ArrayList<String>(); // <7, [1,4,3]>
			
			for (Text val : values) {
				String s = val.toString();
				if (s.charAt(0) == 'P') {
					P.add(s.substring(1)); // [1~7]
				}
				else {
					L.add(s.substring(1)); // [1,4,3]
				}
			}
			...
			for (String A : P) {
				...
				for (String B : L) {
					...
					for (String C : S) {
						...
						context.write(new Text( A+"rr~"+B ), NullWritable.get());
	...
	public static void main(String[] args) throws Exception {
		...
		job1.setMapperClass(Geodesic.EdgesMapper.class);
		job1.setReducerClass(Geodesic.RemoveEdgesReducer.class);
		...
		job2.setMapperClass(Geodesic.EdgesMapper.class);
		job2.setReducerClass(Geodesic.CountEdgesReducer.class);
		...
		job3.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job3, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job3, new Path(args[2]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job4.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job4, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job4, new Path(args[3]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job5.setJarByClass(Geodesic.class);
		job5.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job5, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job5, new Path(args[4]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job6.setJarByClass(Geodesic.class);
		job6.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job6, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job6, new Path(args[5]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job7.setJarByClass(Geodesic.class);
		job7.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job7, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job7, new Path(args[6]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job8.setJarByClass(Geodesic.class);
		job8.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job8, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job8, new Path(args[7]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job9.setJarByClass(Geodesic.class);
		job9.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job9, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job9, new Path(args[8]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job10.setJarByClass(Geodesic.class);
		job10.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job10, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job10, new Path(args[9]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job11.setJarByClass(Geodesic.class);
		job11.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job11, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job11, new Path(args[10]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job12.setJarByClass(Geodesic.class);
		job12.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job12, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job12, new Path(args[11]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job13.setJarByClass(Geodesic.class);
		job13.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job13, new Path(args[11]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job13, new Path(args[12]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job14.setJarByClass(Geodesic.class);
		job14.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job14, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job14, new Path(args[13]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job15.setJarByClass(Geodesic.class);
		job15.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job15, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job15, new Path(args[14]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job16.setJarByClass(Geodesic.class);
		job16.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job16, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job16, new Path(args[15]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job17.setJarByClass(Geodesic.class);
		job17.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job17, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job17, new Path(args[16]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job18.setJarByClass(Geodesic.class);
		job18.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job18, new Path(args[16]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job18, new Path(args[17]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job19.setJarByClass(Geodesic.class);
		job19.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job19, new Path(args[11]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job19, new Path(args[18]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job20.setJarByClass(Geodesic.class);
		job20.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job20, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job20, new Path(args[19]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job21.setJarByClass(Geodesic.class);
		job21.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job21, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job21, new Path(args[20]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job22.setJarByClass(Geodesic.class);
		job22.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job22, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job22, new Path(args[21]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job23.setJarByClass(Geodesic.class);
		job23.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job23, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job23, new Path(args[22]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job24.setJarByClass(Geodesic.class);
		job24.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job24, new Path(args[22]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job24, new Path(args[23]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job25.setJarByClass(Geodesic.class);
		job25.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job25, new Path(args[16]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job25, new Path(args[24]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job26.setJarByClass(Geodesic.class);
		job26.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job26, new Path(args[11]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job26, new Path(args[25]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job27.setJarByClass(Geodesic.class);
		job27.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job27, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job27, new Path(args[26]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job28.setJarByClass(Geodesic.class);
		job28.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job28, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job28, new Path(args[27]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job29.setJarByClass(Geodesic.class);
		job29.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job29, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job29, new Path(args[28]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job30.setJarByClass(Geodesic.class);
		job30.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job30, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job30, new Path(args[29]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job31.setJarByClass(Geodesic.class);
		job31.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job31, new Path(args[29]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job31, new Path(args[30]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job32.setJarByClass(Geodesic.class);
		job32.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job32, new Path(args[22]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job32, new Path(args[31]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job33.setJarByClass(Geodesic.class);
		job33.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job33, new Path(args[16]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job33, new Path(args[32]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job34.setJarByClass(Geodesic.class);
		job34.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job34, new Path(args[11]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job34, new Path(args[33]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job35.setJarByClass(Geodesic.class);
		job35.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job35, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job35, new Path(args[34]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job36.setJarByClass(Geodesic.class);
		job36.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job36, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job36, new Path(args[35]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job37.setJarByClass(Geodesic.class);
		job37.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job37, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job37, new Path(args[36]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job38.setJarByClass(Geodesic.class);
		job38.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job38, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job38, new Path(args[37]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job39.setJarByClass(Geodesic.class);
		job39.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job39, new Path(args[37]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job39, new Path(args[38]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job40.setJarByClass(Geodesic.class);
		job40.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job40, new Path(args[29]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job40, new Path(args[39]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job41.setJarByClass(Geodesic.class);
		job41.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job41, new Path(args[22]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job41, new Path(args[40]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job42.setJarByClass(Geodesic.class);
		job42.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job42, new Path(args[16]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job42, new Path(args[41]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job43.setJarByClass(Geodesic.class);
		job43.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job43, new Path(args[11]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job43, new Path(args[42]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job44.setJarByClass(Geodesic.class);
		job44.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job44, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job44, new Path(args[43]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job45.setJarByClass(Geodesic.class);
		job45.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job45, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job45, new Path(args[44]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job46.setJarByClass(Geodesic.class);
		job46.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job46, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job46, new Path(args[45]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job47.setJarByClass(Geodesic.class);
		job47.setReducerClass(Geodesic.PlusOneReducer.class);
		...
		MultipleInputs.addInputPath(job47, new Path(args[1]), TextInputFormat.class, Geodesic.ListMapper.class);
		MultipleInputs.addInputPath(job47, new Path(args[46]), TextInputFormat.class, Geodesic.PreviousMapper.class);
		...
		job48.setJarByClass(Geodesic.class);
		job48.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job48, new Path(args[46]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job48, new Path(args[47]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job49.setJarByClass(Geodesic.class);
		job49.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job49, new Path(args[37]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job49, new Path(args[48]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job50.setJarByClass(Geodesic.class);
		job50.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job50, new Path(args[29]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job50, new Path(args[49]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job51.setJarByClass(Geodesic.class);
		job51.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job51, new Path(args[22]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job51, new Path(args[50]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job52.setJarByClass(Geodesic.class);
		job52.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job52, new Path(args[16]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job52, new Path(args[51]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job53.setJarByClass(Geodesic.class);
		job53.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job53, new Path(args[11]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job53, new Path(args[52]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job54.setJarByClass(Geodesic.class);
		job54.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job54, new Path(args[7]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job54, new Path(args[53]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job55.setJarByClass(Geodesic.class);
		job55.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job55, new Path(args[4]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job55, new Path(args[54]), TextInputFormat.class, Geodesic.LengthBMapper.class);
		...
		job56.setJarByClass(Geodesic.class);
		job56.setReducerClass(Geodesic.LengthAdjustmentReducer.class);
		...
		MultipleInputs.addInputPath(job56, new Path(args[2]), TextInputFormat.class, Geodesic.LengthAMapper.class);
		MultipleInputs.addInputPath(job56, new Path(args[55]), TextInputFormat.class, Geodesic.LengthBMapper.class);
